...
iva_input_path_H1="/cluster/project/pangolin/processes/influenza/IA_H3/working/mutation_frequencies/0_table_for_plotting/H3_Mutations.tsv"
out_path="/cluster/project/pangolin/resources/cowwid/rsv_iva_heatmaps/results"

./iva_heatmapt.R \
  -i "/${iva_input_path_N1},${iva_input_path_N2},${iva_input_path_H1},${iva_input_path_H1}" \
  -o "${out_path}" \
